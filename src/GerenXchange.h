/* GerenXchange -- the no nonsense (T)FTP server
 *
...
#ifndef GerenXchange_H_
#define GerenXchange_H_
...
/* TFTP Minimum segment size, specific to GerenXchange */
